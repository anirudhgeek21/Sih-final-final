  ...
  return (
    <div className="App">
                ...
                {g1&& 
                    <div
                    id="panel"
                    className="mt-24 visible absolute right-0 z-50 w-1/6  ml-auto bg-white no-underline  text-black h-40 rounded-md space-y-2 shadow-xl shadow-blue-100"
                >
                ...
                {f1&& <div
                    id="menu"
                    className="mt-24 visible absolute right-0 z-50 text-black z-50 h-28 w-1/6 ml-auto bg-white no-underline rounded-md space-y-2 shadow-xl shadow-blue-100"
                >
                    <li className="flex justify-center hover:bg-gray-300">
                    <a href="">MY PROFILE</a>
                    </li>
        ...
        <nav className=" bg-black py-4 sticky">
            <div className="flex   pt-3">
                ...
                <div className="bg-white text-black mr-2 h-9 w-56 font-semibold justify-center flex text-xl rounded-lg text-center ml-[8%]" >
                    {head}
                </div>
                </div>
